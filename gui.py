...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, PID, KalmanFilter):
        super().__init__()
        self.PID = PID
        ...
        self.rpm_true = 0.0
        self.u = 0.0
        self.pid = self.PID(self.kp_spin.value(), self.ki_spin.value(), self.kd_spin.value())
        self.kf = self.KalmanFilter(a=self.friction_spin.value(), g=10.0, dt=self.dt, Q=0.01, R=self.noise_spin.value()**2)
